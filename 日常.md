...
--------
#### 1.Eclipse安装主题
* Eclipse->Window->General->Appearance中没有Color Theme时，要安装，在Help->Eclipse Marketplace中搜索Color Eclipse Theme搜索到之后点击install即可,安装完成后在Aperarance中就会有color theme 选择对应的颜色主题，即可，这里修改的是编辑区域的颜色主题，工具选项和面板的颜色不会改变，要改变这些颜色，需要另外下载插件，自行百度